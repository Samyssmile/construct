...
2. **Semantic tokens** — purpose-driven aliases (`color.brand.primary → {color.stone.950}`). These are what components consume. Swapping a theme means remapping semantic tokens while primitives stay untouched.
